...
from dlon import device as device_settings
import logging
...
class BaseFilter(IFilter):
    ...
    def _scale_to_square(self, orig: PilImage, targ: int) -> PilImage:
        # a simple stretch to fit a square makes a difference in rendering quality/consistency.
        # padding to the square as well (reflect, symetric, constant, etc).  Not as good!
        targ_sz = (targ, targ)
